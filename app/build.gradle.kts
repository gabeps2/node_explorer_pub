...
android {
    namespace = "com.gbrl.dev.lightningnode"
    compileSdk = 35
    ...
    defaultConfig {
        applicationId = "com.gbrl.dev.lightningnode"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        debug {
            // Disabled to use specified version of jacoco instead of the version bundled with AGP
